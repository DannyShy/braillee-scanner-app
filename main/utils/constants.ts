...
export const NAPS_SCAN_CLI_PATH_WIN32 = path.join(pathToOsResources, 'naps2-8.1.4-win-x64/App/NAPS2.Console.exe');
...
export const NAPS_SCAN_PROFILES_PATH_WIN32 = path.join(pathToOsResources, 'naps2-8.1.4-win-x64/Data/profiles.xml');
